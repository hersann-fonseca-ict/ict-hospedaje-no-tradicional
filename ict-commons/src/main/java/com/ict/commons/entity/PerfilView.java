...
public class PerfilView implements Serializable {
	...
	public PerfilView(Long id, Long perfil, String perfilNombre, Long tipoServicio, String tipoServicioNombre, String codigo,
			String tipoIdentificacion, String identificacion, String nombre, String primerApellido,
			String segundoApellido, String provincia, String canton, String distrito, String direccion, String telefono, String correo,
			String url, Boolean aprobado, Boolean desafiliado, Boolean pendienteDesafiliar, Boolean rechazado,
			Date fechaAprobacion, Date fechaDesafiliacion, Date fechaRechazo, String motivoDesafiliacion,
			String motivoRechazo, Long empresa, Long inmueble, Long analista, Long jefe, Boolean editable) {
		super();
		this.id = id;
		this.perfil = perfil;
	...
	@Column(nullable = false, length = 255, name = "tipo_identificacion", insertable = false, updatable = false)
	@ApiModelProperty(required = true, example = "Nacional", value = "Tipo de identificacion")
	...
	@Column(nullable = false, length = 80, name = "primer_apellido", insertable = false, updatable = false)
	@ApiModelProperty(required = true, example = "Sanchez", value = "Primer apellido")
	private String primerApellido;

	@Column(nullable = true, length = 80, name = "segundo_apellido", insertable = false, updatable = false)
	@ApiModelProperty(required = true, example = "Ramirez", value = "Segundo apellido")
	...
	@Column(name = "url", length = 30, nullable = true, insertable = false, updatable = false)
	@ApiModelProperty(required = false, example = "www.prueba.com", value = "URL")
	private String url;
